...
\subsection{Workflow}
The methodological workflow employed in this study consisted of several steps and processes which aimed at analysis of geospatial information and image processing. It also included diverse data obtained from different sources of information. To illustrate the multi-source approach to data processing, the workflow is presented in the diagram scheme shown in Figure \ref{fig04}.

\begin{figure}[H]
    \begin{center}
%    \setlength{\unitlength}{0.5cm}
	\hspace{-35pt}\includegraphics[width=10.0cm]{Fig_04.jpg}
    \end{center}
    \caption{Methodological flowchart schematically representing the workflow applied in this research. Software: RStudio, R, library 'grViz'. Scheme source: author.}
    \label{fig04}
\end{figure}

\subsection{Data}
Satellite images present a reliable source of information for detecting the extent of floods and visualising inundated areas using time series analysis. Their applications is reported in many existing studies with a focus on environmental monitoring \cite{Sheonty,Islam2016,Lemenkova202229,Ferdous,Lemenkova202321}. In this study, we used four Landsat 8-9 Operational Land Imager (OLI) and Thermal Infrared Sensor (TIRS) multispectral satellite images for environmental mapping of Ganges Delta, Bangladesh. The data are available freely from the United States Geological Survey (USGS) repository were used in this work, Figure \ref{fig01}. The images were pre-projected as original data and had the following technical characteristics: Datum and Ellipsoid World Geodetic System 84 (WGS84), stored in Universal Transverse Mercator (UTM) and Worldwide Reference System (WRS). 
...
A multilayer perceptron (MLP) presents a feedforward Artificial Neural Network (ANN), a branch of DL methods \cite{su151813786}. It consists of fully connected neurons with a nonlinear activation function that is organised in at least three layers, Figure \ref{figDL}. 

\begin{figure}[H]
    \begin{center}
	\includegraphics[width=14.0cm]{Fig_DL.jpg}
    \end{center}
