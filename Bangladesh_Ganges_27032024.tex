...
\hl{In hydrological studies and coastal management, detecting the areas prone to floods, is essential issue. Cartographic visualization of flooded landscapes using Remote Sensing (RS) data aims at flood hazard assessment and includes the analysis of the degree of flood impact, evaluation of the affected area and estimation of changes in the post-flood periods} \cite{}. \hl{Such analysis enables to highlight the spatial extent of the flood and spatio-temporal dynamics and has been acknowledged as one of the most powerful approaches in hydrological hazard monitoring. Indeed, satellite image analysis enables to reveal information about the consequences of flood as environmental changes such as affected land patches, destroyed areas, declined vegetation coverage and disrupted ecosystems} \cite{}. 
