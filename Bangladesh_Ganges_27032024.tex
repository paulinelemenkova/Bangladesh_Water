...
Flooded areas in Ganges River Delta detected and mapped using MaxLike methods are presented as a series of the resulting maps in Figure \ref{fig09} and Figure \ref{fig10} and deep learning (DL) is presented in Figure \ref{fig11} and Figure \ref{fig12}. \hl{The classified images show the pre and post-flood inundation maps for the Ganges delta region during March and November on 2021, 2022 and 2023, based on the Landsat images. }The findings\hl{ }revealed a changing pattern of expanded floods in the post-flood period in Ganges Delta, and inequality in distribution of inundated areas covered by water by consequent years (2021, 2022 and 2023). \hl{Thus, the results show the distribution of continuing waterbodies in March which increases to November covering an area of southern Bangladesh.}

\hl{In March 2021, a total flood-inundated area was 2lower, with most inundation was occurring in cropland (Class 6), followed by Urban settlement (Class 8) and orchard areas (Class 9), and other areas such as wetlands, mangroves and aquaculture (Classes 2, 3 and 10). } 
