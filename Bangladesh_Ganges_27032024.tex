...
\hl{This} research has demonstrated an example of using such approach in cartography and \hl{RS} data processing. Thus, it has led to a greater understanding of the importance of using advanced methods of machine learning for environmental monitoring. 
